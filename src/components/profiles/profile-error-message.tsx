...
const errorMessages: Record<string, string> = {
  ...
  "auth-missing": "Bu kullanıcının giriş hesabı bağlı değil.",
  "auth-password": "Şifre sıfırlama işlemi tamamlanamadı.",
  "server-config": "Sunucu yapılandırması eksik.",
  "self-password-reset": "Kullanıcı kendi şifresini bu panelden değiştiremez.",
