  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/25 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-border bg-background text-foreground shadow-sm hover:border-[#c9d5df] hover:bg-[#f8fafc] hover:text-foreground aria-expanded:bg-[#f8fafc] aria-expanded:text-foreground",
        secondary:
          "border border-border bg-[#edf3f7] text-[#093657] hover:bg-[#e4edf4] aria-expanded:bg-[#e4edf4] aria-expanded:text-[#093657]",
        ghost:
          "text-foreground hover:bg-[#eef4f8] hover:text-foreground aria-expanded:bg-[#eef4f8] aria-expanded:text-foreground",
        destructive:
